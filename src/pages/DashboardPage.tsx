...
const RiskIndicator: React.FC<RiskIndicatorProps> = ({ icon, label, level, color }) => (
  <div className="flex flex-col items-center p-6 bg-white rounded-lg border border-gray-200 hover:shadow-md transition-shadow">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-10">
            ...
            <section>
              ...
              {smartSuggestions.length > 0 ? (
                ...
                <div className="bg-white rounded-lg border border-gray-200 p-10 text-center">
                  ...
                  <p className="text-gray-500 text-lg mb-2">No properties available</p>
            ...
            {/* Saved Listings */}
            <section>
              <h2 className="text-xl font-bold text-gray-900 mb-8">Saved Listings</h2>
              
              <div className="space-y-6">
                {savedListings.map((property) => (
                  <div key={property.id} className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm hover:shadow-md transition-shadow">
                    <div className="flex items-start gap-6">
                      <img 
                        src={property.images[0] || '/api/placeholder/120/120'} 
                        alt={property.title}
                      ...
                      <div className="flex-1">
                        ...
                        <div className="flex items-center gap-4 mt-4">
                          <button className="flex items-center gap-2 text-gray-600 hover:text-blue-600 px-4 py-2 rounded-lg hover:bg-blue-50 transition-colors">
          ...
          <div className="space-y-8">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              ...
              <button className="w-full mt-6 text-blue-600 hover:text-blue-700 font-medium flex items-center justify-center gap-2 py-2 px-4 rounded-lg hover:bg-blue-50 transition-colors">
            ...
            <div className="bg-white rounded-xl border border-gray-200 p-6 shadow-sm">
              ...
              {recentlyViewed.length === 0 && (
                <div className="text-center py-8">
                  ...
                  <p className="text-gray-500">No recent views yet</p>
                  <p className="text-gray-400 text-sm mt-1">Start exploring properties!</p>
                </div>
              )}
            </div>
          </div>
